...
export const button = (options: ButtonOptions = {}) => {
    ...
    return cn(
        "inline-flex items-center justify-center gap-2 whitespace-nowrap border font-medium leading-normal outline-none transition-colors select-none focus-visible:ring-2 focus-visible:ring-primary/50 focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:cursor-not-allowed not-disabled:cursor-pointer data-[selected]:border-primary data-[selected]:bg-surface-alt data-[selected]:text-foreground data-[pressed]:border-primary data-[pressed]:bg-surface-alt data-[pressed]:text-foreground aria-selected:border-primary aria-selected:bg-surface-alt aria-selected:text-foreground",
